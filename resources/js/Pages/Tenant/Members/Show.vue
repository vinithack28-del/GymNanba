...
const formatAmount = (paise) => `Rs. ${Number((paise || 0) / 100).toFixed(0)}`;
                ...
                <div class="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
                    ...
                    <div class="flex flex-col gap-4 px-6 py-5">
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 w-5 text-xs font-semibold text-slate-500">Ph</span>
                            <div>
                        ...
                        <div v-if="member.email" class="flex items-start gap-3">
                            <span class="mt-0.5 w-5 text-xs font-semibold text-slate-500">Em</span>
                            <div>
                        ...
                        <div v-if="member.gender || member.dob" class="flex items-start gap-3">
                            <span class="mt-0.5 w-5 text-xs font-semibold text-slate-500">ID</span>
                            <div>
                        ...
                        <div v-if="member.branch" class="flex items-start gap-3">
                            <span class="mt-0.5 w-5 text-xs font-semibold text-slate-500">Br</span>
                            <div>
                        ...
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 w-5 text-xs font-semibold text-slate-500">Pl</span>
                            <div>
                        ...
                        <div v-if="member.start_date || member.expiry_date" class="flex items-start gap-3">
                            <span class="mt-0.5 w-5 text-xs font-semibold text-slate-500">Dt</span>
                            <div>
                        ...
                        <div v-if="member.address" class="flex items-start gap-3">
                            <span class="mt-0.5 w-5 text-xs font-semibold text-slate-500">Ad</span>
                            <div>
                        ...
                        <div v-if="member.notes" class="flex items-start gap-3">
                            <span class="mt-0.5 w-5 text-xs font-semibold text-slate-500">Nt</span>
                            <div>
                        ...
                        <div class="flex items-start gap-3">
                            <span class="mt-0.5 w-5 text-xs font-semibold text-slate-500">In</span>
                            <div>
